...
| Pricing model | Free self-hosted; Thally Cloud from $50 per workspace/month on an annual subscription with 3 team members | Free Starter; Pro is $540/month with Monthly selected or $450/month with Annual selected; Enterprise is custom |
| Included AI credits | 10,000 per month | 10,000 per month; additional credits are $0.01 each |
...
Thally is free to self-host with unlimited pages and readers. Thally Cloud is $60 per workspace per month on a monthly subscription, or $50 per month on an annual subscription. Both are billed monthly and include 10,000 AI credits per month plus three team members. Each additional active member or pending invitation adds $20 to the monthly bill. Thally Cloud also includes managed hosting, cited AI answers, reviewable updates drafted from relevant product changes, readiness gates, analytics, and the Cloud dashboard. Enterprise pricing is custom and scoped to each customer's security, identity, support, and contract requirements. Readers are never billed. Full details are on the [pricing page](/pricing) and in the machine-readable [pricing.md](/pricing.md).
