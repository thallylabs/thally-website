...
Thally is free to self-host with unlimited pages and readers. Thally Cloud is $8 per editor per month ($60 per editor per year billed annually) and adds managed hosting, Thally AI answers, Track, readiness CI checks, and the admin dashboard. Enterprise is $15 per editor per month with SSO, audit logs, and a 99.9% SLA. Readers are never billed. Full details are on the [pricing page](/pricing) and in the machine-readable [pricing.md](/pricing.md).
