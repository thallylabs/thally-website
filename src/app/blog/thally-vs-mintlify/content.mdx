...
| Pricing model | Free self-hosted; Thally Cloud from $50 per workspace/month on an annual subscription with 3 team members | Free Starter; paid Pro and Enterprise tiers |
...
Mintlify's Starter plan is free and includes five editor seats, Git sync, search, and an MCP server. Automations and its writing agent require Pro or Enterprise. Their pricing page is the source of truth for current prices, credit allowances, and Enterprise options.
