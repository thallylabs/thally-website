...
Thally Free includes one managed documentation site per workspace with hosting, a custom domain, agent-readiness checks, unlimited pages, and unlimited readers. The MIT-licensed engine can also be self-hosted for free. Thally Cloud, which adds unlimited managed sites, the automation pipeline, and 10,000 AI credits per month, is $60 per workspace per month, or $50 on an annual subscription, with three members included.
