...
Thally is MIT licensed. Self-hosting is free forever with unlimited pages and readers; you deploy a Next.js repo you own to any host. Thally Cloud is $60 per workspace each month, or $600 per workspace each year ($50 per month equivalent), with three team members included. Additional active members or pending invitations are $20 per month or $200 per year each. It adds managed services, Thally AI, Track, and the dashboard. Enterprise pricing is custom and adds SSO, audit-log access, custom terms, and priority support. Details are on the [pricing page](/pricing).
