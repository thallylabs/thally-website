...
Thally is MIT licensed. Self-hosting is free forever with unlimited pages and readers; you can deploy the Next.js project to any compatible host. Thally Cloud is $60 per workspace per month on a monthly subscription, or $50 per month on an annual subscription. Both are billed monthly and include three team members. Each additional active member or pending invitation adds $20 to the monthly bill. Thally Cloud adds managed services, AI answers, documentation automation, and the dashboard. Enterprise pricing is custom and scoped to each customer's security, identity, support, and contract requirements. Details are on the [pricing page](/pricing).
