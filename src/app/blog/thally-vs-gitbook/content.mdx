...
Thally is MIT licensed. Self-hosting is free forever with unlimited pages and readers; you deploy a Next.js repo you own to any host. Thally Cloud, at $8 per editor per month, adds managed hosting, Thally AI, Track, and the dashboard. Enterprise adds SSO, audit logs, and a 99.9% SLA at $15 per editor per month. Details on the [pricing page](/pricing).
