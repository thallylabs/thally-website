...
Thally is MIT licensed. Self-hosting is free forever with unlimited pages and readers; you deploy a Next.js repo you own to any host. Thally Cloud is $60 per editor each month, or $600 per editor each year ($50 per month billed annually), and adds managed services, Thally AI, Track, and the dashboard. Enterprise pricing is custom and adds SSO, audit-log access, custom terms, and priority support. Details are on the [pricing page](/pricing).
