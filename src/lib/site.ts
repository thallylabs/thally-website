...
export const SITE_TAGLINE = "The Product Knowledge Layer for Software Teams";
...
export const SOCIAL_PREVIEW_DESCRIPTION =
  "When a pull request merges, Thally works out what changed, traces the impact across your docs, website, and help center, and opens evidence-backed PRs your team approves.";
